...
Back in the [Postgres C extension documentation](https://www.postgresql.org/docs/current/xfunc-c.html), we can see some simple examples of converting between C types and Postgres's Datum type.
