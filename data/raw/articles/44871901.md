...
*   [Travel](travel.html)
   ...
   [![a rabbit wearing a funky sweater](../media/interface/home.png) ![Home](../media/interface/home_txt.png) ![Home](../media/interface/home_txt_underline.png)](home.html)[![a mariner rabbit with a spyglass, coiled in ropes](../media/interface/about.png) ![About](../media/interface/about_txt.png) ![About](../media/interface/about_txt_underline.png) ](about.html)[![a rabbit holding some rolled up documents](../media/interface/knowledge.png) ![Knowledge](../media/interface/knowledge_txt.png) ![Knowledge](../media/interface/knowledge_txt_underline.png) ](knowledge.html)[![a rabbit laying on their belly and writing into a book](../media/interface/articles.png) ![Articles](../media/interface/articles_txt.png) ![Articles](../media/interface/articles_txt_underline.png) ](articles.html)[![a rabbit working on a project, taking measurements while while a hard hat](../media/interface/projects.png) ![Projects](../media/interface/projects_txt.png) ![Projects](../media/interface/projects_txt_underline.png) ](projects.html)[![a rabbit sitting in a small boat wearing a rain coat](../media/interface/travel.png) ![Travel](../media/interface/travel_txt.png) ![Travel](../media/interface/travel_txt_underline.png)](travel.html)

# weathering software winter

This is a blog post based on a transcript of a talk by Devine on November 26th 2022. Watch the [video version](https://www.youtube.com/watch?v=9TJuOwy4aGA) on (YouTube). The slideshow presentation was made using [Adelie](adelie.html).
...
Thank you for reading.
 ...
 [![hundred rabbits logo consisting of one hundred white dots](../media/interface/logo.svg)](home.html)**Hundredrabbits** © 2025

[All Pages](../site/index.html) | [Support](../site/support.html) | [Store](../site/store.html) | [Contact](../site/rabbits.html) | [BY-NC-SA 4.0](https://github.com/hundredrabbits/100r.co/blob/main/LICENSE.by-nc-sa-4.0.md)

[](https://merveilles.town/@neauoire)[](https://merveilles.town/@rek)